...
st.title("About Us")
st.write("Here is your comprehensive healthcare companion. Our app offers a state-of-the-art healthcare recommendation system that connects you with doctors immediately based on their availability and specialization. Whether you're in need of urgent care or planning ahead, Health Guardian allows you to book appointments at your specified location, ensuring convenience and peace of mind.")
